...
// the ERP planner at runtime (CaptainOfIndustry.Infrastructure).
//
...
// ones with each release. See docs/extractor.md for
...
namespace ErpForFactoryGames.CaptainOfIndustry.Extractor;
