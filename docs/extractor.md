...
(the `CaptainOfIndustry.Infrastructure` catalogue provider in the [ERP repo](https://github.com/erp-for-factory-games/ErpForFactoryGames))
ingests the result.
...
Built via `dotnet build src/ErpForFactoryGames.CaptainOfIndustry.Extractor/` directly.
